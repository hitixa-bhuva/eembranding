<?php
$Title = "MoonshineExpression | EEM";
$MetaDescription = "MOONSHINE Decorative Laminates From striking visuals to compelling content, every element is meticulously curated to captivate your audience and drive";
$MetaKeywords = "Moonshine Decorative Laminates, decorative laminates design, laminate branding, high-quality laminates, interior design laminates, premium laminate collection, creative laminate designs, stylish laminate solutions, laminate industry branding, best decorative laminates.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">Moonshine<span> Expression</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
