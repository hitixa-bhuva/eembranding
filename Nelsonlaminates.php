<?php
$Title = "Nelsonlaminates | EEM";
$MetaDescription = "NELSON Enchanting From striking visuals to compelling content, every element is meticulously curated to captivate your audience and drive engagement.";
$MetaKeywords = "Nelson Laminates, premium laminates, decorative laminates, laminate branding, interior design laminates, high-quality laminate sheets, modern laminate designs, stylish laminates, creative branding, visual storytelling.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">Nelson<span> laminates</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                                        ...
                                                        <div class="elementor-image-carousel swiper-wrapper"
                                                            ...
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        ...
                                                                        src="./assest/img/portfolio/nelsonenchanting/01-26.jpg"
                                                                        alt="01"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/02-23.jpg"
                                                                        alt="04"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/03-24.jpg"
                                                                        alt="03"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-prev" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/04-22.jpg"
                                                                        alt="05"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-active" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/05-18.jpg"
                                                                        alt="06"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-next" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/06-11.jpg"
                                                                        alt="02"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/nelsonenchanting/07-10.jpg"
                                                                        alt="07"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
