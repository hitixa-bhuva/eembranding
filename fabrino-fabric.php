<?php
$Title = "FABRINO Fabric | EEM";
$MetaDescription = "MORBI KING FABRIC Conceptual inspiration highlights the intricate and delicate nature of fabric textures and patterns with a fresh, modern approach.";
$MetaKeywords = "Fabrino Fabric, Morbi King Fabric, fabric-inspired design, intricate textures, delicate patterns, modern aesthetics, textile design influence, premium branding, artistic fabric visuals, high-end design solutions.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">FABRINO  <span> Fabric</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                            ...
                                            <div class="elementor-element elementor-element-0641f35 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <p class="elementor-heading-title elementor-size-default">
                                                        Conceptual inspiration highlights the intricate and delicate nature of fabric textures and patterns with a fresh, modern approach. Visual Elements utilizes a soothing pastel blue background to create a serene and inviting atmosphere, allowing the design to feel both contemporary and elegant. Imagery and typography that feature the word "FABRIC" prominently with vertical images in pastel colors, symbolizing fabric, emphasizing the attention to detail and craftsmanship in the laminate designs.                                            </div>
