<?php
$Title = "Dazzle BerryPastel | EEM";
$MetaDescription = "DAZZLE BERRY Lucullian Transformative Sophistication Nature-Inspired Elegance Incorporates a hummingbird as the centerpiece, symbolizing grace and";
$MetaKeywords = "Dazzle Berry, pastel design, Lucullian sophistication, nature-inspired elegance, premium branding, luxury design, artistic branding, creative identity, modern aesthetics, brand storytelling.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">Dazzle <span> BerryPastel</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                            ...
                                            <div class="elementor-element elementor-element-c70ccb1 elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <h2 class="elementor-heading-title elementor-size-default">
                                                        DAZZLE BERRY<br>
                                                        <span>Lucullian Transformative Sophistication</span>
                                                    </h2>
                                                </div>
                                            </div>
                                            <div class="elementor-element elementor-element-0641f35 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <p class="elementor-heading-title elementor-size-default">
                                                        Nature-Inspired Elegance Incorporates a hummingbird as the centerpiece, symbolizing grace and transformation. The bird, in motion, highlights the dynamic essence of the laminate collection. Using a palette of gold and red to evoke a sense of luxury and warmth. These colors blend seamlessly with the natural theme, enhancing the sophisticated allure of the title, "Lucullian Transformative Sophistication in Every Stroke." Antegrate abstract lines around the hummingbird to represent the intricate patterns and textures of the laminates. These lines add a modern touch while maintaining the natural, fluid aesthetics, reflecting the transformative and sophisticated nature of the product.                                                    </p>
                                                </div>
                                            </div>
                            ...
                            <section
                                ...
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e0a1450"
                                        data-id="e0a1450" data-element_type="column">
                                        <div
                                            class="elementor-widget-wrap elementor-element-populated e-swiper-container">
                                            <div class="elementor-element elementor-element-cbef735 project-details-custom-slider elementor-arrows-position-inside elementor-pagination-position-outside elementor-widget elementor-widget-image-carousel e-widget-swiper"
                                                data-id="cbef735" data-element_type="widget"
                                                    ...
                                                    <div class="elementor-image-carousel-wrapper swiper swiper-initialized swiper-horizontal swiper-pointer-events"
                                                        ...
                                                        <div class="elementor-image-carousel swiper-wrapper"
                                                            ...
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        ...
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/01-24.jpg"
                                                                        alt="01"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/02-21.jpg"
                                                                        alt="04"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/03-22.jpg"
                                                                        alt="03"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-prev" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/04-20.jpg"
                                                                        alt="05"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-active" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/05-16.jpg"
                                                                        alt="06"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-next" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/06-9.jpg"
                                                                        alt="02"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/07-8.jpg"
                                                                        alt="07"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/08-3.jpg"
                                                                        alt="01"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/dazzle-berryenpastel/09-1.jpg"
                                                                        alt="04"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="swiper-pagination-bullet" data-bullet-index="0"
                                                                ...
                                                                data-bullet-index="1" aria-label="Go to slide 2"
                                                                ...
                                                                class="swiper-pagination-bullet" data-bullet-index="6"
                                                                aria-label="Go to slide 7"></span></div>
