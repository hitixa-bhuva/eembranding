<?php
$Title = "KIANA | Dive into the Splash of Colors & Shapes";
$MetaDescription = "Explore KIANA’s vibrant world of colors and dynamic shapes. Experience artistic expression, modern creativity, and innovative design aesthetics.";
$MetaKeywords = "Kiana, splash of colors, vibrant design, colorful aesthetics, artistic expression, modern creativity, dynamic visuals, premium branding, innovative surfaces, stylish design.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">KIANA Dive  <span> in the Splash of colors
                                Shape</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                            ...
                                            <div class="elementor-element elementor-element-0641f35 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <p class="elementor-heading-title elementor-size-default">
                                                        From striking visuals to compelling content, every element is meticulously curated to captivate your audience and drive engagement. Whether you're launching a new product line or seeking to revamp your existing catalogue, our team of experienced designers is here to bring your vision to life and leave a lasting impression on your customers.                                            <div class="elementor-element elementor-element-13f087a elementor-widget__width-auto elementor-absolute elementor-hidden-mobile z-index-plus elementor-widget elementor-widget-bg-shapes animated slideInRight"
                                                        ...
                                                        <div class="elementor-image-carousel swiper-wrapper"
                                                            ...
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        ...
                                                                        src="./assest/img/portfolio/keton-micabeautiful/01-23.jpg "
                                                                        alt="01"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/02-20.jpg"
                                                                        alt="04"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-duplicate"
                                                                role="group" aria-roledescription="slide"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/03-21.jpg"
                                                                        alt="03"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-prev" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/04-19.jpg"
                                                                        alt="05"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-active" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/05-15.jpg"
                                                                        alt="06"></figure>
                                                            </div>
                                                            <div class="swiper-slide swiper-slide-next" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/06-8.jpg"
                                                                        alt="02"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
                                                                ...
                                                                <figure class="swiper-slide-inner"><img decoding="async"
                                                                        class="swiper-slide-image"
                                                                        src="./assest/img/portfolio/keton-micabeautiful/07-7.jpg"
                                                                        alt="07"></figure>
                                                            </div>
                                                            <div class="swiper-slide" role="group"
