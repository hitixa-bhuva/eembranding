<?php
$Title = "MORBI KING In Star | EEM";
$MetaDescription = "MORBI KING IN STAR Conceptual Inspiration that conveys a sense of sophistication and modern elegance with a blend of bold and soft color palettes. Visual";
$MetaKeywords = "Morbi King In Star, sophisticated design, modern elegance, bold color palette, soft hues, premium laminates, artistic branding, high-end aesthetics, stylish surface design, contemporary visuals.";
?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="breadcrumb-content-two">
                            <h1 class="title">MORBI KING <span> In Star</span></h1>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                            ...
                                            <div class="elementor-element elementor-element-0641f35 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <p class="elementor-heading-title elementor-size-default">
                                                        Conceptual Inspiration that conveys a sense of sophistication and modern elegance with a blend of bold and soft color palettes. Visual Elements utilizes a rich royal blue background to exude luxury and depth, contrasting with pastel color boxes to add a contemporary and fresh touch. Typography and Highlighting design the word "Instar" with clean, stylish typography, enhanced by strategically placed pastel color boxes to highlight and draw attention to the title.                                            </div>
